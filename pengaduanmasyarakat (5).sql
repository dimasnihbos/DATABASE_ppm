...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2023 at 04:35 AM
...
('01', 'dimas', 'dimas03', 'dimasganteng', '089699784281'),
('02', 'wildan', 'wildan2', 'wildananakmd', '0847252865'),
('03', 'asep', 'asepmotor', 'asep123', '08123456789'),
('04', 'abe', 'abedul', '$2y$10$TocmOmTmcGqK7ZNC7oqFPuECqexbf4RMzDMLn05fQ678A5bhdL6qm', '0876543235');
...
(323, '2023-08-29', '01', '', 'keren', '', '0'),
(326, '2023-08-29', '02', '', 'aselole', '', '0');
...
(1, 'abdulganteng', 'abdul', '111', '08123456789', 'petugas');
...
--
ALTER TABLE `pengaduan`
  MODIFY `id_pengaduan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=329;
